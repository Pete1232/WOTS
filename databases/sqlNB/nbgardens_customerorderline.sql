...
CREATE TABLE `customerorderline` (
  ...
  `CustomerOrder_CustomerOrderId` int(11) NOT NULL,
  KEY `fk_CustomerOrderLine_CustomerOrder1_idx` (`CustomerOrder_CustomerOrderId`)
...
INSERT INTO `customerorderline` VALUES (1,10,1),(2,5,1),(3,3,1),(3,6,2),(3,4,2),(3,1,2),(1,7,3),(1,1,2);
